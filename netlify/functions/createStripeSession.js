...
//     if (!snapshot.exists()) return { statusCode:400, body:JSON.stringify({error:"Event not found"}) };

//     const eventData = snapshot.val();
//     if (!eventData.stripeAccountId) return { statusCode:400, body:JSON.stringify({error:"Merchant not linked"}) };
